...
---
#### [2.5.2] [Build:0330.26]
- Added a progress bar and non-blocking backend apply handling.
- Added a restart message to the main menu.
- Added elevated UAC launch support for the executable, removing the need to manually right-click and run as administrator.
- Disabled buttons while settings are being applied.
- Hid the PowerShell window during backend execution.
- Added a **Themes** menu with:
  - **Dark Mode**
  - **Light Mode**
  - **System Default** (default setting)
- Added a **Help** menu with:
  - **Check For Updates** (pop-out window)
  - **Discord** (placeholder)
  - **Donation Link** (placeholder only)
